...
const pricingCategories = [
  {
    ...
    services: [
      ...
      { name: "Blowout & Styling", price: "35", duration: "45 min" },
      {
        ...
        price: "85",
        duration: "2 hrs",
        description: "Includes toner and styling",
      },
      {
        name: "Highlights",
        price: "120",
      ...
      { name: "Balayage", price: "150", duration: "3 hrs" },
      {
        ...
        price: "55",
        duration: "1 hr",
        description: "Deep conditioning or keratin",
      },
    ],
  },
  {
          ...
          {packageData.map((pkg, index) => (
            ...
            >
                  ...
                  {pkg.includes.map((item, idx) => (
                    <li key={idx} className="flex items-center">
                      <svg
                        viewBox="0 0 20 20"
                        fill="currentColor"
                        className="w-5 h-5 mr-2 text-beauty-pink"
                      >
                        <path
                          fillRule="evenodd"
              ...
              <div className="mt-auto text-center">
                <Link
                  to="/booking"
                  className="beauty-button inline-block text-gray-800 text-sm w-full"
                >
                  Book Now
                </Link>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mb-6 text-gray-600">
              ...
              discounted services, priority booking, and special member-only
              events.
            </p>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start">
                <div className="mr-4 mt-1">
                  <svg
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    className="w-5 h-5 text-beauty-pink"
                  >
                    <path
                      fillRule="evenodd"
                      d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Save on every visit with members-only pricing
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Book appointments before they're available to the public
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    $10 monthly credit toward retail products
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="section-container bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Give the gift of beauty and relaxation with our gift cards,
          ...
          >
            ...
            <h3 className="text-xl font-serif mb-1">Sheboli beauty salon</h3>
