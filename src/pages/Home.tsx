...
const serviceData = [
  {
    ...
    title: "Hair Styling",
    description:
      "Get a fresh look with our expert styling services including cuts, coloring, and treatments.",
  },
  {
    icon: "https://img.icons8.com/cotton/64/facial-mask.png",
    title: "Facial Treatments",
    description:
      "Rejuvenate your skin with our premium facial treatments tailored to your skin type.",
  },
  {
    icon: "https://img.icons8.com/cotton/64/micro-needle.png",
    title: "Nail Services",
    description:
      "Express yourself with our professional manicure and pedicure services.",
  },
  {
...
const testimonialData = [
  {
    quote:
      "The stylist was amazing and really understood exactly what I wanted. My hair has never looked better!",
  ...
  {
    quote:
      "The facial treatment was so relaxing and my skin is glowing! I've already booked my next appointment.",
    author: "Michael Chen",
  ...
  {
    quote:
      "The massage was exactly what I needed. The therapist was professional and the atmosphere was so peaceful.",
...
const Home = () => {
  ...
  return (
    <>
      <HeroSection
        title="Welcome to Sheboli beauty salon "
      ...
      <section className="section-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="section-title">Welcome to Sheboli beauty salon</h2>
            <p className="mb-6 text-gray-600">
              At Sheboli beauty salon, we believe everyone deserves to look and
              feel their best. Our expert team of stylists and therapists are
              dedicated to providing personalized services that enhance your
              natural beauty.
            </p>
            <p className="mb-6 text-gray-600">
              With years of experience and a passion for beauty, our
              professionals use only premium products to deliver outstanding
              results in a relaxing atmosphere.
            </p>
            <Link
              to="/about"
              className="beauty-button inline-block text-gray-800"
            >
              About Us
            </Link>
          </motion.div>
      ...
      <section className="section-container bg-gray-50">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Experience our comprehensive range of beauty services designed to
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            treatment from our expert stylists.
          </motion.p>
      ...
      <section className="section-container">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Hear from our satisfied clients about their experiences at Serenity
            Beauty Salon.
          </p>
        </div>
